...
namespace NovelSite.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// </summary>
        [BindProperty]
        public RegisterViewModel Input { get; set; } // InputModel Base Identity
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser(); BaseIdentity
                ...
                var user = new ApplicationIdentityUser
                {
                    ...
                    Email = Input.Email,
                    AvatarFileName = Input.Avatar != null ? Input.Avatar.FileName : "",
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    //Create Base Visual Novel Lists
                    await HttpQueries.CreateBaseLists(userId);

                    //TODO Валидация изображения

                    if (Input.Avatar != null)
                    {
                        int indexLastDot = Input.Avatar.FileName.LastIndexOf('.');
                        int fileExtensionsNameLength = Input.Avatar.FileName.Length - indexLastDot;
                        string fileExtensionName = Input.Avatar.FileName.Substring(indexLastDot + 1, fileExtensionsNameLength - 1);
                        string fileName = $"{Input.Username}.{fileExtensionName}";

                        string avatarUrl = await _fileService.UploadFileAsync(Input.Avatar, userId, fileName);
